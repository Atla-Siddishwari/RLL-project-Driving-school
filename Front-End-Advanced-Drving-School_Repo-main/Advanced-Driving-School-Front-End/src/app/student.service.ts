...
export class StudentService {
  ...
  url1: string = "http://localhost:8001/drivingschool/student/list";
  url2: string = "http://localhost:8001/drivingschool/student/insert";
  url3: string = "http://localhost:8001/drivingschool/student/edit";
  url4: string = "http://localhost:8001/drivingschool/student/remove";
  url5: string = "http://localhost:8001/drivingschool/student/updatepwd";
  url6: string = "http://localhost:8001/drivingschool/student/package";
  url7: string = "http://localhost:8001/drivingschool/student/bookingdetails";
