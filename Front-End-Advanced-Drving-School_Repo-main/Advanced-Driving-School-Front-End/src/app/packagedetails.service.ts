...
export class PackagedetailsService {
  ...
  url1: string = "http://localhost:8001/drivingschool/packages/list";
  url2: string = "http://localhost:8001/drivingschool/packages/insert";
  url3: string = "http://localhost:8001/drivingschool/packages/edit";
  url4: string = "http://localhost:8001/drivingschool/packages/remove";
  url5: string = "http://localhost:8001/drivingschool/packages/list/local";
  url6: string = "http://localhost:8001/drivingschool/packages/list/remote";

  constructor(private http: HttpClient) { }

  getPackageDetails(): Observable<PackageDetails[]> {
    return this.http.get<PackageDetails[]>(this.url1);
  }
